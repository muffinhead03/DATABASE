...
public class staff_setpieceTactics_Edit extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					staff_setpieceTactics_Edit frame = new staff_setpieceTactics_Edit();
	 ...
	 * Create the frame.
	 */
	public staff_setpieceTactics_Edit() {
		...
		JLabel lblNewLabel = new JLabel("세트피스 전술 수정");
		...
		JLabel lblNewLabel_1 = new JLabel("세트피스 전술 ID");

	...
	public void loadAchievedStatisticsToTable(JTable table) {
	    ...
	    try {
	        ...
	        String sql = 
	        	    ...
	        	    "FROM DB2025_GameRec G " +
	        	    "JOIN DB2025_GameStat S ON G.idGame = S.idGame " +
	        	    "JOIN DB2025_Tactics T ON G.idSetpiece = T.idTactic " +
	        	    "WHERE T.idTeam = ? " +
	        	    "GROUP BY T.idTactic, T.tacticName " +
